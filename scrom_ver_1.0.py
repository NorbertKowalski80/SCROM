...
def convert_pptx_to_scorm(pptx_file, output_folder, style="black", fullscreen=False):
    try:
        ...
        generate_html_files(slide_images, output_folder, style, fullscreen)
...
def generate_html_files(slide_images, output_folder, style="black", fullscreen=False):
    try:
...
class SCORMConverterApp:
    ...
    def create_widgets(self):
        ...
        tk.Checkbutton(self.root, text="Tryb pełnoekranowy", variable=self.fullscreen, font=self.button_font,
    ...
    def convert(self):
        ...
        try:
            ...
            convert_pptx_to_scorm(self.pptx_file, self.output_folder, self.style, self.fullscreen_mode)
